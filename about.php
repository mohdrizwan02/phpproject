...
?>
<div class="container ms-4 " style="margin-bottom:70px;padding-bottom:30px;padding-top:30px;">
    <div class="row border border-2 rounded border-dark p-3" style="width:1470px;">
        <div class="col-8">
        <h4>At Happy Pets, our mission is to connect loving homes with pets in need, creating happier lives for both animals and humans alike.</h4>
            ...
            <div class="col-4">
                <div class="img-container">
                    <img src="https://source.unsplash.com/random/500×500/?pets" class="img-fluid" style="height:320px;width:440px;margin-top:20px;">
                </div>
                <div class="img-container">
                    <img src="https://source.unsplash.com/random/500×500/?pets" class="img-fluid" style="height:320px;width:440px;margin-top:20px;">
                </div>
